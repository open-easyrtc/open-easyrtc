...
// Application Options
option.defaultAppName       = "default";                    // The default application a connection belongs to if it is not initially specified.


// Room Options
option.defaultRoomName      = "default";                    // The default room a connection joins if it is not initially specified.
