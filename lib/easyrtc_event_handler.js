/**
 * Event handlers used by EasyRTC. Many of these can be overridden using server options.
 * 
 * @module      easyrtc_event_handler
 ...
 */
eventHandler.onAuthenticate = function(socket, easyrtcid, appName, username, credential, easyrtcAuthMessage, next) {
    next(null);
};
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onAuthenticated = function(connectionObj, next) {
    next(null);
};
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onConnection = function(socket, easyrtcid, next){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onDisconnect = function(connectionObj, next){
 ...
 */
eventHandler.onEasyrtcAuth = function(socket, easyrtcid, msg, socketCallback, callback){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onEasyrtcCmd = function(connectionObj, msg, socketCallback, next){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onEasyrtcMsg = function(connectionObj, msg, socketCallback, next){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onEmitEasyrtcCmd = function(connectionObj, msgType, msg, socketCallback, next){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onEmitEasyrtcMsg = function(connectionObj, msgType, msg, socketCallback, next){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onEmitError = function(connectionObj, errorCode, socketCallback, next){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onEmitReturnAck = function(connectionObj, socketCallback, next){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onEmitReturnError = function(connectionObj, socketCallback, errorCode, next){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onEmitReturnToken = function(connectionObj, socketCallback, next){
 ...
 */
eventHandler.onLog = function(level, logText, logFields) {
    var consoleText = "";
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onMsgTypeRoomJoin = function(connectionObj, rooms, socketCallback, next){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onMsgTypeRoomLeave = function(connectionObj, rooms, socketCallback, next){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onMsgTypeGetRoomList = function(connectionObj, socketCallback, next){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onMsgTypeSetPresence = function(connectionObj, presenceObj, socketCallback, next){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onRoomCreate = function(appObj, creatorConnectionObj, roomName, roomOptions, callback){
 ...
 * @param       {string} roomName       Room name which uniquely identifies a room within an EasyRTC application.
 */
eventHandler.onRoomJoin = function(connectionObj, roomName, callback){
    pub.util.logDebug("["+connectionObj.getEasyrtcid()+"] Running func 'onRoomJoin'");
    connectionObj.joinRoom(roomName, callback);
};
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onRoomLeave = function(connectionObj, roomName, next){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onShutdown = function(next){
 ...
 * @param       {nextCallback} next     A success callback of form next(err).
 */
eventHandler.onStartup = function(next){
    if (!_.isFunction(next)) {
        next = function(err) {};
    }
