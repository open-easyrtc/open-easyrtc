...
module.exports.onEasyrtcAuth    = function(socket, easyrtcid, msg, socketCallback, callback){
    ...
    async.waterfall([
        function(asyncCallback) {
            ...
            pub.isValidIncomingMessage("easyrtcAuth", msg, null, asyncCallback);   
        },
...
module.exports.onEasyrtcCmd = function(connectionObj, msg, socketCallback, next){
    ...
    async.waterfall([
        function(asyncCallback) {
            // Check message structure
            pub.isValidIncomingMessage("easyrtcCmd", msg, connectionObj.getApp(), asyncCallback);   
        },
...
module.exports.onEasyrtcMsg = function(connectionObj, msg, socketCallback, next){
    ...
    async.waterfall([
        function(asyncCallback) {
            // Check message structure
            pub.isValidIncomingMessage("easyrtcMsg", msg, connectionObj.getApp(), asyncCallback);   
        },
