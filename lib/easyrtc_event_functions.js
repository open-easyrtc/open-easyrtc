...
module.exports.onConnection     = function(socket, easyrtcid, next){
    ...
    async.waterfall([
        function(callback) {
            var newAppName = pub.getOption("defaultApplicationName");
...
module.exports.onEmitError      = function(easyrtcid, errorCode, msgRefId, socketCallback, next){
    pub.util.logDebug("Running func 'onEmitError'");
    if(!_.isFunction(socketCallback)) {
        socketCallback = function(returnMsg) {
            pub.util.logDebug("["+connectionObj.getEasyrtcid()+"] easyRTC error: unhandled ACK return message.", returnMsg);
        };
    }
    ...
    pub.eventHandler.emit("emitEasyrtcCmd", easyrtcid, "error", msg, null, next);
};
