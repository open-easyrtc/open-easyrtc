 ...
 */
module.exports.onAuthenticated  = function(connectionObj, next) {
    next(null);
};
    ...
    async.waterfall([
        ...
        function(asyncCallback) {
            ...
            // If no room is initially provided, have them join the default room (if enabled)
                ...
                connectionObj.joinRoom(connectionObj.getApp().getOption("roomDefaultName"), function(err, roomObj){
                    asyncCallback(err);
                });
            }
 ...
 */
module.exports.onEmitReturnAck  = function(connectionObj, socketCallback, next){
 ...
 */
module.exports.onEmitReturnError    = function(connectionObj, socketCallback, errorCode, next){
 ...
 *
 * @param       {Object} connectionObj  EasyRTC connection object
 * @param       {Object} socketCallback Socket.io return message callback
 * @param       {Object} next           Callback to call upon completion. Delivers parameter (err).
 */
module.exports.onEmitReturnToken    = function(connectionObj, socketCallback, next){
 ...
 */
module.exports.onMsgTypeRoomJoin    = function(connectionObj, rooms, socketCallback, next){
 ...
 */
module.exports.onMsgTypeRoomLeave   = function(connectionObj, rooms, socketCallback, next){
 ...
 * Meant to be run upon receiving a easyrtcCmd message with a msgType of 'roomLeave'
 */
module.exports.onMsgTypeGetRoomList = function(connectionObj, socketCallback, next){
 ...
 */
module.exports.onMsgTypeSetPresence = function(connectionObj, presenceObj, socketCallback, next){
 ...
 */
module.exports.onRoomCreate     = function(appObj, creatorConnectionObj, roomName, roomOptions, callback){
 ...
 */
module.exports.onRoomJoin       = function(connectionObj, roomName, callback){
