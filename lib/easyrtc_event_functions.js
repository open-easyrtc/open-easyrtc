    ...
    async.waterfall([
        ...
        function(asyncCallback) {
            ...
            switch(msg.msgType) {
                ...
                case "setPresence":
                    pub.events.emit("setPresence", connectionObj, msg.msgData.setPresence, socketCallback, next);
                    break;

                case "roomJoin":
                    pub.events.emit("roomJoin", connectionObj, msg.msgData.roomJoin, socketCallback, next);
                    break;

                case "roomLeave":
                    pub.events.emit("roomLeave", connectionObj, msg.msgData.roomLeave, socketCallback, next);
                    break;

                case "getRoomList":
                    pub.events.emit("getRoomList", connectionObj, socketCallback, next);
                    break;
