    ...
    async.waterfall([
        ...
        function(callback) {
            ...
            connectionObj.socket.on('easyrtcCmd', function(msg) {
                ...
                pub.eventHandler.emit('easyrtcCmd', easyrtcid, msg, function(err){
            ...
            connectionObj.socket.on('message', function(msg) {
                ...
                pub.eventHandler.emit('message', easyrtcid, msg, function(err){
            ...
            connectionObj.socket.on('disconnect', function(data) {
                ...
                pub.eventHandler.emit('disconnect', easyrtcid, function(err){
...
module.exports.onLog = function(level, logText, logFields) {
    ...
    if (logFields) {
        if (pub.util.isError(logFields)) {
            console.log(consoleText, logFields.stack.magenta);
        }
        else if (pub.util.isWarning(logFields)) {
            console.log(consoleText, logFields.stack.cyan);
        }
        else {
