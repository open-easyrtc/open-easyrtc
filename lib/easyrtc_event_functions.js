...
module.exports.onEasyrtcCmd = function(connectionObj, msg, socketCallback, next){
    ...
    switch(msg.msgType) {
        ...
        case "roomJoin":
            socketCallback({msgType:'ack'});
            pub.util.logWarning("[" + connectionObj.getEasyrtcid() + "] WebRTC roomJoin command received. This feature is not yet complete.");
            next(null);
            break;
        case "roomLeave":
            socketCallback({msgType:'ack'});
            pub.util.logWarning("[" + connectionObj.getEasyrtcid() + "] WebRTC roomLeave command received. This feature is not yet complete.");
            next(null);
            break;
        case "candidate":
        case "offer":
 ...
 */
module.exports.onRoomJoin      = function(connectionObj, roomName, socketCallback, next){
