...
exports.initHttpApp = function(httpApp, next) {
    httpApp.configure( function() {
        ...
        if (e.option.demosEnable) {
            eu.logDebug("Setting up demos to be accessed from '" + e.option.demosPublicFolder + "/'");
            httpApp.get(e.option.demosPublicFolder + "/*", function(req, res) {
                res.sendfile(
            ...
            httpApp.get(e.option.demosPublicFolder, function(req, res) {res.redirect(e.option.demosPublicFolder + "/");});
        }

        if (e.option.apiEnable) {
            // Set the easyRTC API files
            // TODO: Minified version
            eu.logDebug("Setting up API files to be accessed from '" + e.option.apiPublicFolder + "/'");
            httpApp.get(e.option.apiPublicFolder + "/easyrtc.js",                  function(req, res) {res.sendfile('api/easyrtc.js',                  {root:__dirname + "/../"});});
            httpApp.get(e.option.apiPublicFolder + "/easyrtc.css",                 function(req, res) {res.sendfile('api/easyrtc.css',                 {root:__dirname + "/../"});});
            httpApp.get(e.option.apiPublicFolder + "/img/powered_by_easyrtc.png",  function(req, res) {res.sendfile('api/img/powered_by_easyrtc.png',  {root:__dirname + "/../"});});
        }

        if (e.option.apiEnable && e.option.apiOldLocationEnable) {
