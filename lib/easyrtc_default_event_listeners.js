    ...
    async.waterfall([
        ...
        function(isMsgValid, msgErrorCode, asyncCallback) {
            ...
            if (!isMsgValid) {
                ...
                asyncCallback(new pub.util.ConnectionError("["+connectionObj.getAppName()+"]["+ connectionObj.getEasyrtcid() +"] EasyRTC Auth message received with invalid message format [" + msgErrorCode + "]. Disconnecting socket."));
                return;
            }
            asyncCallback(null);
        },
