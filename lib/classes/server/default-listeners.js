...
const pub = require("./../../easyrtc_public_obj"); // EasyRTC public object
...
eventListener.onStartup = function(next) {
    ...
    // TODO use this instead of duplcate code
    var sendResponse = function(req, res, filePath) {
    ...
    async.waterfall([
        function(callback) {
            ...
            if (pub.getOption("apiEnable")) {
                ...
                pub.httpApp.get(pub.getOption("apiPublicFolder") + "/easyrtc.js",     function(req, res) { sendResponse(req, res, "api/easyrtc.js"); });
                pub.httpApp.get(pub.getOption("apiPublicFolder") + "/easyrtc_ft.js",  function(req, res) { sendResponse(req, res, "api/easyrtc_ft.js"); });
                pub.httpApp.get(pub.getOption("apiPublicFolder") + "/easyrtc.css",    function(req, res) { sendResponse(req, res, "api/easyrtc.css"); });
            ...
            if (pub.getOption("apiEnable") && pub.getOption("apiOldLocationEnable")) {
                ...
                pub.httpApp.get("/js/easyrtc.js", function(req, res) { sendResponse(req, res, "api/easyrtc.js"); });
                pub.httpApp.get("/css/easyrtc.css", function(req, res) { sendResponse(req, res, "api/easyrtc.css"); });
            }
