...
const defaultOptions = require("./../easyrtc_default_options"); // EasyRTC global variable
...
const Server = class Server {
     ...
     */
    getConnectionCount = function(callback) {
     ...
     */
    getAppWithEasyrtcid = function(easyrtcid, callback) {
        for (var appName in this.app) {
            if (this.app.hasOwnProperty(appName)) {
                if (
     ...
     */
    getConnectionWithEasyrtcid = function(easyrtcid, callback) {
        for (var appName in this.app) {
            if (this.app.hasOwnProperty(appName)) {
                if (
                    this.app[appName].connection.hasOwnProperty(easyrtcid) &&
