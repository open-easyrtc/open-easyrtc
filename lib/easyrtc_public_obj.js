...
pub.createApp = function(appName, options, callback) {
    ...
    pub.app(appName, function(err, appObj) {
        ...
        function(err) {
            ...
            else if (appObj.getOption("roomDefaultEnable")) {
                // Create default room
...
pub.app = function(appName, callback) {
    ...
    /**
     * NOT YET IMPLEMENTED - Returns application level field object for a given field name.
     *  
     * @ignore
     * @memberof    pub.appObj
     ...
     */
    appObj.getFieldNames = function(limitToIsShared, callback) {
        var fieldNames = new Array();
        for (var fieldName in e.app[appName].field) {
            if (!limitToIsShared || e.app[appName].field[fieldName].fieldOptions.isShared) {
    ...
    /**
     * NOT YET IMPLEMENTED - Returns an object containing all field names and values within the application. Can be limited to fields with isShared option set to true.
     *
     * @ignore
     * @memberof    pub.appObj
     * @param       {boolean}   limitToIsShared Limits returned fields to those which have the isShared option set to true.
     ...
     */
    appObj.getFieldValues = function(limitToIsShared, callback) {
        var fieldObj = {};
        for (var fieldName in e.app[appName].field) {
            if (!limitToIsShared || e.app[appName].field[fieldName].fieldOptions.isShared) {
                fieldObj[fieldName] = {
     ...
     * @param       {?Object}   fieldOptions    Field options (such as isShared which defaults to false)
    ...
    appObj.setField = function(fieldName, fieldValue, fieldOptions, next) {
        ...
        e.app[appName].field[fieldName] = {
            ...
            fieldOptions:{isShared: ((_.isObject(fieldOptions) && fieldOptions.isShared)?true:false)}
        };
