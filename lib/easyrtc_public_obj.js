...
pub.app = function(appName, callback) {
    ...
    appObj.connection = function(easyrtcid, callback) {
        ...
        /**
         * Generates a full room connection list for the given connection 
         * @param {String} roomStatus, Can have possible values of "join"|"update"|"leave"
         * @param {Object} roomMap. Map of rooms to generate connection list for. If null, then all rooms will be used.
        ...
        connectionObj.room = function(roomName, callback) {
            ...
            connectionRoomObj.emitRoomDataDelta = function(isLeavingRoom, next) {
                ...
                msg.msgData.roomData[roomName] = {roomName:roomName, roomStatus:"update", listDelta:{}};
