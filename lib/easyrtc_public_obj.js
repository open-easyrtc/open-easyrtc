            ...
            case "easyrtcCmd":
                switch (msg.msgType) {
                    ...
                    case "setUserCfg" :
                        ...
                        // setUserCfg.connectionList
                        if (msg.msgData.setUserCfg.connectionList !== undefined && (!_.isObject(msg.msgData.setUserCfg.connectionList) || _.isEmpty(msg.msgData.setUserCfg.connectionList))) {
                            callback(null, false, "MSG_REJECT_BAD_STRUCTURE");
                            return;
                        }
                        // TODO: Go through connectionList to confirm key's are easyrtcid's
