...
pub.app = function(appName, callback) {
    ...
    appObj.connection = function(easyrtcid, callback) {
         ...
         * @returns     {Object}    Field object
         */
        connectionObj.getFieldSync = function(fieldName, callback) {
            if (!e.app[appName].connection[easyrtcid].field[fieldName]) {
                return {"fieldName": fieldName, "fieldOption": {}, "fieldValue": null};
            }
    ...
    appObj.room = function(roomName, callback) {
        ...
        /**
         * Returns room level field object for a given field name. If the field is not set, it will return a field object will a null field value.  This is a synchronous function, thus may not be available in custom cases where state is not kept in memory.
         *
         * @memberof    pub.appObj.roomObj
         * @param       {string}    fieldName   Field name
         * @returns     {Object}        Field object
         */
        roomObj.getFieldSync = function(fieldName, callback) {
            if (!appObj.isRoomSync(roomName)) {
                return {"fieldName": fieldName, "fieldOption": {}, "fieldValue": null};
            }
            if (!e.app[appName].room[roomName].field[fieldName]) {
