...
console.log("Joining session:", sessionKey);
    ...
    appObj.room = function(roomName, callback) {
         ...
         * @ignore 
         */
        roomObj.emitRoomDataFieldUpdate = function(next){
            var msgData = {"roomData": {}};
            msgData.roomData[roomName] = {
                "roomName":     roomName,
                "roomStatus":   "update"
            };
            roomObj.getFields(true, function(err, fieldObj){
                ...
                msgData.roomData[roomName].field = fieldObj;

                // TODO: Get list of connections in room
