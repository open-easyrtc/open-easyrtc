    ...
    appObj.connection = function(easyrtcid, callback) {
        ...
        connectionObj.room = function(roomName, callback) {
            ...
            connectionRoomObj.emitRoomDataDelta = function(isLeavingRoom, next) {
                ...
                if (isLeavingRoom) {
                    msg.msgData.roomData[roomName].clientListDelta.removeClient = {};
                    msg.msgData.roomData[roomName].clientListDelta.removeClient[easyrtcid] = {easyrtcid:easyrtcid};
                } else {
                    var connectionRoom = e.app[appName].connection[easyrtcid].room[roomName];
                    msg.msgData.roomData[roomName].clientListDelta.updateClient = {};
                    // TODO: Add additional fields
                    msg.msgData.roomData[roomName].clientListDelta.updateClient[easyrtcid] = {
                        easyrtcid:easyrtcid,
