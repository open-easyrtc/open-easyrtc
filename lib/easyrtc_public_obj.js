...
pub.util.isValidIncomingMessage = function(type, msg, appObj, callback) {
    ...
    switch (type) {
        case "easyrtcAuth":
            ...
            // Local function will be called after application has been retrieved. This allows us to use application level options to validate syntax.
            var checkRestEasyrtcAuth = function() {
                // msgData.username
            ...
            // Try to obtain the connections application object (if not already provided), then call checkRestEasyrtcAuth();
            if (!appObj){
            ...
            // Return early. Callback is called from checkRestEasyrtcAuth
            return;
            break;
