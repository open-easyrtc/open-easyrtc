...
/**
 *  Method to replace this module with another. This should only be done before server.listen() has run. 
 * 
 * @param       {string}    fileLocation    File path to module.
 * @return      {Object}                    A reference to the new public object.
 */
pub.util.replacePublicObject = function(fileLocation) {
    module.exports = pub = require(fileLocation);
