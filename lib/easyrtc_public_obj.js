...
module.exports.app = function(appName, callback) {
    ...
    appObj.getOption = function(optionName) {
        return ((e.app[appName].option[optionName] === 'undefined') ? module.exports.getOption(optionName) : (e.app[appName].option[optionName])); 
    };
...
pub.util.logWarning("Just gnerated this awesome roomData:", roomData);
